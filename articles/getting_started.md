...
#> Creating new version '20260113T204957Z-684ca'
...
#> ✔ Connected
#> ── Board Content ───────────────────────────────────────────────────────────────
#> Board Path: /tmp/RtmpyXBPeF/dbproject_demo217a1312d37d
#> # A tibble: 1 × 6
#>   name             type  title          created             file_size meta      
#>   <chr>            <chr> <chr>          <dttm>              <fs::byt> <list>    
#> 1 cachedConnection rds   connConnectio… 2026-01-13 20:49:57       233 <pins_met>
#> ── Database Content ────────────────────────────────────────────────────────────
#> Database Path: /tmp/RtmpyXBPeF/dbproject_demo217a1312d37d/demo.duckdb
```
...
#> # Database: DuckDB 1.4.3 [unknown@Linux 6.11.0-1018-azure:R 4.5.2//tmp/RtmpyXBPeF/dbproject_demo217a1312d37d/demo.duckdb]
...
#> Creating new version '20260113T204957Z-81121'
...
#>   <chr>            <chr> <chr>          <dttm>              <fs::byt> <list>    
#> 1 cachedConnection rds   connConnectio… 2026-01-13 20:49:57       233 <pins_met>
#> 2 mtcars           rds   mtcars: a pin… 2026-01-13 20:49:57       268 <pins_met>
#> ── Database Content ────────────────────────────────────────────────────────────
#> Database Path: /tmp/RtmpyXBPeF/dbproject_demo217a1312d37d/demo.duckdb
#> ℹ Tables:
#> • mtcars
